...
TERMS = [{"name": "指定AVD名", "canonical": "jec_25cm_kotlin_Pixel 9a", "forbidden": ["jec_25cm_kotlin_Pixel_9a"]}]
...
class ExtractTest(unittest.TestCase):
    def test_text_with_inline_tags_is_one_segment(self):
        self.assertEqual(
            sources_of("<p>アプリは、<strong>画面</strong>と<code>Kotlin</code>で作ります。</p>"),
            ["アプリは、<strong>画面</strong>と<code>Kotlin</code>で作ります。"],
        )
    ...
    def test_segment_needs_japanese_outside_protected_elements(self):
        ...
        html = ("<table><tr><td><code>テキストを変更</code></td><td>Kotlin / XML</td>"
    ...
    def test_translate_no_inside_a_sentence_is_rejected(self):
        ...
        with self.assertRaisesRegex(localize.LocalizeError, 'には translate="no" を付けられません'):
            page_of('<p>AVD名は <span translate="no">jec_25cm_kotlin_Pixel 9a</span> です。</p>')
...
class ValidateTest(unittest.TestCase):
    ...
    def test_reports_each_kind_of_problem(self):
        cases = (
            ...
            ("正式表記がありません", "jec_25cm_kotlin_Pixel 9a を選ぶ", "Select the Pixel 9a"),
            ("禁止表記", "選ぶ", "Select jec_25cm_kotlin_Pixel_9a"),
...
class CommandTest(unittest.TestCase):
    ...
    def test_sync_drops_translations_that_no_longer_pass_the_check(self):
        ...
        self.sync()
        self.merge({"<code>Run</code>を押します。": "Press <code>Run</code> on jec_25cm_kotlin_Pixel_9a."})
        ...
        self.assertIn("jec_25cm_kotlin_Pixel_9a", item["previous_translation"])
        self.assertEqual(localize.check(self.settings()), [])
